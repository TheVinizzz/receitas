  ...
  <div class="min-h-[calc(100vh-4rem)] bg-gradient-to-br from-orange-50 via-white to-red-50 flex items-center justify-center px-4 py-12">
    <div class="w-full max-w-md">
      <div class="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
        ...
        <h2 class="text-3xl font-bold text-center text-gray-900 mb-2">Entrar</h2>
        <p class="text-center text-gray-600 mb-8">Acesse sua conta no RecipeHub</p>
        ...
        <div class="mt-6 text-center">
          ...
          <router-link to="/register" class="text-orange-600 hover:text-orange-700 font-semibold">
            Cadastre-se
          </router-link>
        </div>
      </div>
